...
SPECIES_METADATA = {
    "human": {
        ...
        "mya": 0,
        "name": "Homo sapiens",
        "qfo_proteome": "UP000005640",
        "qfo_subdir": "Eukaryota",
    },
    "mouse": {
        "taxon_id": "10090",
        "mya": 100,
        "name": "Mus musculus",
        "qfo_proteome": "UP000000589",
        "qfo_subdir": "Eukaryota",
    },
    "chicken": {
        "taxon_id": "9031",
...
def process_species(species: str, qfo_dir: Path, outdir: Path, force: bool = False):
    ...
    print(
        f"  After QfO filter: {after:,} proteins with Pfam ({before:,} before filter), {len(df):,} domain records"
    )
