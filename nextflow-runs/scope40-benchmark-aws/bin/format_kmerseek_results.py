...
Reformat raw kmerseek CSV output into the 4-column TSV expected by
evaluate_scope40.py, keeping the best max_containment per (query, target).

Output columns: query_name  target_name  max_containment  poisson_pvalue
